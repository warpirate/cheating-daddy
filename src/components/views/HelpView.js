            ...
            <div class="help-container">
                <div class="option-group">
                    ...
                    <div class="community-links">
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://meharnolan.com')}>
                            🌐 Official Website
                        </div>
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://github.com/sohzm/meharnolan')}>
                            📂 GitHub Repository
                        </div>
                ...
                <div class="option-group">
                    ...
                    <div class="profiles-grid">
                        ...
                        <div class="profile-item">
                            <div class="profile-name">First Day Work</div>
                            <div class="profile-description">Calm guidance for navigating your first day at a new job</div>
                        </div>
                        <div class="profile-item">
                        ...
                        <div class="profile-item">
                            <div class="profile-name">Online Test</div>
                            <div class="profile-description">Rapid assistance for timed online tests and coding challenges</div>
                        </div>
                        <div class="profile-item">
                            <div class="profile-name">Homework Helper</div>
                            <div class="profile-description">Comprehensive help with assignments and problem sets</div>
                        </div>
                    </div>
                </div>
